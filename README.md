...
📚 **Full version**: See [`full-version.pdf`](./full-version.pdf)

> This repository hosts the full version of our paper accepted to **CAV 2025**.  
It includes all appendices and proofs omitted from the conference version due to space constraints.
> Please cite the official version published by Springer when referring to this work.

> 📘 The official version will appear in the *Lecture Notes in Computer Science (LNCS)* series published by Springer.

© 2025 The Authors. This is the authors' version of the work. The final authenticated publication will be available from Springer.
